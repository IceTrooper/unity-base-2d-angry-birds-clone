...
{
	[CustomPropertyDrawer(typeof(EditableProgressBarAttribute))]
	public class EditableProgressBarPropertyDrawer : PropertyDrawerBase
	{
		...
		private object GetMaxValue(SerializedProperty property, EditableProgressBarAttribute progressBarAttribute)
		{
